...
# [GCC 9.3.0]
# Embedded file name: /home/tomaz/dev/DJND/hrparser/hrparser/spiders/votes_spider.py
# Compiled at: 2020-03-18 14:51:23
# Size of source mod 2**32: 6134 bytes
import scrapy
from datetime import datetime
import json, requests

class VotesSpider37(scrapy.Spider):
    name = 'votes_new'
    ...
    def parse_ballots(self, response_data, url, id, docs, session_name):
        ...
        out_data = {'title':title, 
         ...
         'session_name':session_name}
        return out_data
# okay decompiling votes_spider.cpython-37.pyc
